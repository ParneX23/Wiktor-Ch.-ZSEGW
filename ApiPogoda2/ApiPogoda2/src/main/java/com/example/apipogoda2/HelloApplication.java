...
public class HelloApplication extends Application {
    public String klucz = "miejsceNaKluczApi";
    @Override
    public void start(Stage stage) throws IOException {
        ...
        getWeatherButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                switch (jo.getJSONArray("weather").getJSONObject(0).getString("main")){
                    case "Clear":
                    ...
                    case "Thunderstorm":
                        ...
                        break;
                    case "Snow":
                        icon.add(new ImageView(new Image("E:\\,ZSEL\\3TP\\Aplikacje Desktopowe\\ApiPogoda\\ApiPogoda2\\ApiPogoda2\\icons\\12d@2x.png", 50, 50, true, false)), 0,0);
                        break;
                    case "Mist":
