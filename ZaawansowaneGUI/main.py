...
def show_selection(event):
    ...
    combo_label.config(text=f"Wybrano opcję: {combo.get()}")
...
combo_label = ttk.Label(tab1, text="Nie wybrano żadnej opcji")
combo_label.grid(row=1, column=0, padx=5, pady=5, sticky="w")
