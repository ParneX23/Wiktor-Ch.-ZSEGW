...
class DBModel:
    ...
    def _create_table(self):
        with sqlite3.connect(self.db_name) as conn:
            conn.execute("CREATE TABLE IF NOT EXISTS wizyty (klient TEXT, telefon INTEGER)")
...
class App(tk.Tk):
    ...
    def setup_ui(self):
        ...
        tk.Label(self, text="Numer Telefonu:").pack(pady=5)
    ...
    def handle_save(self):
        ...
        if not name:
            messagebox.showwarning("Błąd", "Wpisz number telefonu!")
            return
